function tau = RNE_formulation(robot,q,dq,ddq,g0)
    ...
    % Initialize variables need for forward equations
    z0 = [0 0 1]';
    w0_0 = [0 0 0]';
    d_w0_0 = [0 0 0]';
    dd_p0_0 = [0 0 -g0]';

    % Matrices from first joint to all
    H0_1 = robot.T_rne{1};
    H1_2 = robot.T_rne{2};
    H2_3 = robot.T_rne{3};
    ...
    % Get matrices from frame to the next frame
    R0_1 = H0_1(1:3,1:3);
    R1_2 = H1_2(1:3,1:3);
    R2_3 = H2_3(1:3,1:3);
    R3_e = H3_e(1:3,1:3);
    
    % Distance vector view from second frame
    ...
    % Forces and torques for rne backward equations
    f_1 = zeros(3,1,'sym');
    f_2 =  zeros(3,1,'sym');
    f_3 =  zeros(3,1,'sym');
    f_e =  zeros(3,1,'sym');
